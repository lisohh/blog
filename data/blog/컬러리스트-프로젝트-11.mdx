...
터미널에 아래처럼 React-table을 설치하고, 맞는 타입도 설치해준다.<br />
`bun add react-table`
...
![boxcount 배열](/static/images/boxcount-array.png)(150px)
...
![entries,row](/static/images/entries_row.png)(150px)
...
![row array](/static/images/row_array.png)(150px)
