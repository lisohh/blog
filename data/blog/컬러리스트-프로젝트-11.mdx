...
>     <br />; pagination도 쉽게 지원할 수 있고 커스텀 디자인에 맞춰 넣을 수 있다.
...
![boxcount 배열](/static/images/boxcount-array.png){: width="300" height=auto }{: .center}
...
![entries,row](/static/images/entries_row.png){: width="300" height=auto }{: .center}
...
![row array](/static/images/row_array.png){: width="300" height=auto }{: .center}
